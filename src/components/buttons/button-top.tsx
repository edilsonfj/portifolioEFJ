...
export function ButtonTop({ children, href }: ItemProps) {
    ...
    const Home = "font-sans font-semibold text-purple-50 text-shadow-md border-2 border-purple-700 hover:bg-purple-700 hover:font-bold transition duration-500 ease-in-out";
